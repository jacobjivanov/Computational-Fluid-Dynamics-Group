...
ax.legend()
ax.set_xlabel(r"Square Grid Dimensions, $d$")
ax.set_ylabel(r"$\ell_2(u_{\mathrm{int}} - u_{\mathrm{ana}})$")
ax.set_title("Comparison of Interpolation Convergence by Method")
