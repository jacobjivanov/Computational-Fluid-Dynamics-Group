...
while t < t_end:
    ...
    if n % 50 == 0:
        ...
        np.save("Vorticity Evolution Development/temp/v6 256 unforced 0.02/Omega n = {0}".format(n), Omega)
        np.save("Vorticity Evolution Development/temp/v6 256 unforced 0.02/t n = {0}".format(n), t)    
