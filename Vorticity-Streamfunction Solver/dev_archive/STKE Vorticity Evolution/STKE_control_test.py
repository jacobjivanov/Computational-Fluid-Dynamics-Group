...
M, N = 128, 128 # computational grid dimensions
...
plt.semilogy(TKE_history[:n], color = 'blue')
plt.xlabel("timestep, $n$")
plt.ylabel("$\mathrm{TKE}(t)$")
plt.title("Turbulent Kinetic Energy over Timestep")
plt.savefig("STKE_Vorticity_Evolution/Turbulent Kinetic Energy over Timestep.png", dpi = 200)
plt.show()