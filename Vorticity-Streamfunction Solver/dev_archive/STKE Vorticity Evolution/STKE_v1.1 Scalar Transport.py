...
M, N = 512, 512 # computational grid dimensions
...
while t < t_end:
    ...
    if n % 20 == 0:
        ...
        np.savez("STKE Vorticity Evolution/temp/STKE v1.1 {0}/Omega+Theta_p+t n = {1}.npz".format(M, n), Omega = Omega, Theta_p = Theta_p, t = t)
