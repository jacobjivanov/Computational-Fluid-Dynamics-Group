...
def save_animation(M, N, tau, s_max, s_int, savepath):
    ...
    ANI = FuncAnimation(fig, update_frame, init_func = lambda: None, frames = range(0, s_max, s_int))
...
if __name__ == "__main__":
    ...
    while t < T:
        if s % s_int == 0:
            ...
            np.savez("data/" + savepath + "/v9 data s = {0}.npz".format(s), t = t, Omega = Omega, P = P)
